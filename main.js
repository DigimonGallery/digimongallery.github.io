...
function createDigimonSection(d){
    ...
    var row = createDigimonCard(d.name, true, true);
...
function createAllDigimon(){
    for(var name in digimonList) {
        var d = digimonList[name];
        bigrow = createDigimonSection(d);
...
var changePage = function(name){  
    ...
    document.getElementById("website").appendChild(dList);
    loadPage();
}
